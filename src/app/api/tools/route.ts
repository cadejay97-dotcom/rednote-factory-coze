...
const tools: Tool[] = [
  ...
  },
  {
    ...
    coreFeature: 'React/JSX 直接渲染成 SVG/PNG，适合稳定生成小红书封面、卡片和轮播首图',
    techStack: 'TypeScript + React JSX',
    rating: 5,
    category: '封面生成',
    scenario: '图文矩阵封面、知识卡片、品牌统一视觉',
    highlight: '最适合做模板化封面引擎的默认方案，和 Next.js App Router 搭配最顺手',
  },
  {
    id: 17,
    name: 'html-to-image',
    github: 'https://github.com/bubkoo/html-to-image',
    coreFeature: '将 React 预览卡片直接导出为 PNG/JPEG/SVG，适合编辑器内快速试图',
    techStack: 'TypeScript + DOM export',
    rating: 4,
    category: '封面生成',
    scenario: '编辑器预览导出、快速本地试图、页面级截图',
    highlight: '适合作为本地预览导出通道，比从零实现截图逻辑更省事',
  },
  {
    id: 18,
    name: 'snapDOM',
    github: 'https://github.com/zumerlab/snapdom',
    coreFeature: '现代 DOM 截图导出库，支持 PNG/JPG/SVG/WebP，适合高保真页面抓图',
    techStack: 'TypeScript + DOM capture',
    rating: 4,
    category: '封面生成',
    scenario: '高保真封面导出、浏览器预览截图、版式验证',
    highlight: '适合作为 html-to-image 的新一代备选，尤其适合浏览器端预览导出',
  },
  {
    id: 19,
    name: 'guizang-social-card-skill',
    github: 'https://github.com/op7418/guizang-social-card-skill',
    coreFeature: '小红书/社媒卡片模板技能，覆盖单页 HTML 转 PNG、布局系统和主题化封面',
    techStack: 'HTML + Playwright + Template Skill',
    rating: 5,
    category: '封面生成',
    scenario: '封面模板参考、布局体系借鉴、批量卡片生产',
    highlight: '非常贴近小红书首图与轮播卡片的工作流，可直接借鉴模板骨架',
  },
];
...
const combos: Combo[] = [
  ...
  },
  {
    id: 5,
    name: '图文矩阵封面发布方案',
    description: '适合每天批量发图文笔记：内容生成、首图生成、草稿填充、人工确认发布',
    level: '进阶',
    steps: [
      {
        title: '批量笔记与封面提示词',
        tools: ['矩阵批量生成', 'image2 封面工厂'],
        desc: '一个选题拆出多条差异化笔记，并为每条生成首图提示词',
      },
      {
        title: '封面批量生产',
        tools: ['image2', 'Satori', 'guizang-social-card-skill'],
        desc: '真实生图走 image2；模板化卡片走 Satori/Playwright，保证矩阵视觉统一',
      },
      {
        title: '安全发布',
        tools: ['小红书发布助手', 'Playwright Worker'],
        desc: '本地浏览器填草稿，截图校验，最终人工点击发布，避免无人值守触发风控',
      },
    ],
  },
];
